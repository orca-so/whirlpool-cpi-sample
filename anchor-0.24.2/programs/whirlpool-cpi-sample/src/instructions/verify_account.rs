...
use whirlpool_cpi::{self, state::{WhirlpoolsConfig, FeeTier, Whirlpool, Position, TickArray}, util::unpack::unpack_tick_array};
...
pub fn handler_tickarray(
  ...
  let tickarray = unpack_tick_array(&ctx.accounts.tickarray)?;
